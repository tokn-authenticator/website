...
export const comparison: ComparisonRow[] = [
  { id: "oss", tokn: "yes", aegis: "yes", googleAuth: "no", twofas: "yes", stratum: "yes", authy: "no" },
  { id: "noCloud", tokn: "yes", aegis: "yes", googleAuth: "partial", twofas: "partial", stratum: "yes", authy: "no" },
  { id: "encryptedVault", tokn: "yes", aegis: "yes", googleAuth: "partial", twofas: "yes", stratum: "yes", authy: "partial" },
  { id: "biometric", tokn: "yes", aegis: "yes", googleAuth: "yes", twofas: "yes", stratum: "yes", authy: "yes" },
  { id: "noGms", tokn: "yes", aegis: "yes", googleAuth: "no", twofas: "partial", stratum: "yes", authy: "no" },
  { id: "localSync", tokn: "yes", aegis: "no", googleAuth: "no", twofas: "no", stratum: "no", authy: "no" },
  { id: "backups", tokn: "yes", aegis: "yes", googleAuth: "no", twofas: "yes", stratum: "yes", authy: "no" },
  { id: "import", tokn: "yes", aegis: "yes", googleAuth: "no", twofas: "yes", stratum: "yes", authy: "no" },
  { id: "customIcons", tokn: "yes", aegis: "yes", googleAuth: "no", twofas: "yes", stratum: "yes", authy: "partial" },
  { id: "groups", tokn: "yes", aegis: "yes", googleAuth: "no", twofas: "yes", stratum: "yes", authy: "no" },
  { id: "materialYou", tokn: "yes", aegis: "yes", googleAuth: "yes", twofas: "partial", stratum: "partial", authy: "no" },
];
